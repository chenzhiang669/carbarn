...
public class Translate {
    ...
    public static String translate(VolcTranslator volcTranslator,
                                   Map<String, String> key_value,
                                   String data, String sourcelang, String targetLang) {
    ...
    public static String translateTypeDetails(VolcTranslator volcTranslator,
        ...
        for (int i = 0; i < json.size(); i++) {
            ...
            String trans_key = translate(volcTranslator, key_value, key, sourceLang, targetLang);
            ...
            for (int j = 0; j < params_in.size(); j++) {
                ...
                String trans_name = translate(volcTranslator, key_value, name, sourceLang, targetLang);
                String trans_value = translate(volcTranslator, key_value, value, sourceLang, targetLang);
