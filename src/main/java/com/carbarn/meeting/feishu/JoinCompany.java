...
public class JoinCompany {
    ...
    private void joinCompany() throws Exception {
        ...
        logger.info("meeting_params appId:{} | appSecret:{} | lark_appId:{} | lark_appSecret:{} | minute_interval:{}", appId, appSecret, lark_appId, lark_appSecret, minute_interval);
        ...
        if (invite_meetings.size() != 0) {
            ...
            for (GoingToStartMeetingDTO goingToStartMeetingDTO : invite_meetings) {
                ...
                String buyer_email = goingToStartMeetingDTO.getBuyer_email();
                ...
                if(buyer_email != null){
                    buyer_invite_infos = FeishuApplyReserve.inviteBuyerJoinCompany(lark_appId, lark_appSecret, null, buyer_email, buyer_nickname , "open_department_id", new String[]{"0"});
                }else if (buyer_phonenum != null) {
                    buyer_invite_infos = FeishuApplyReserve.inviteBuyerJoinCompany(lark_appId, lark_appSecret, buyer_phonenum, null, buyer_nickname, "open_department_id",  new String[]{"0"});
                }

                if (seller_phonenum != null) {
                    seller_invite_infos = FeishuApplyReserve.inviteSellerJoinCompany(appId, appSecret, seller_phonenum, seller_nickname, "open_department_id", new String[]{"0"});
                }
