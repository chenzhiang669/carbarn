package com.carbarn.common.pojo;
...
public class CommonResult<T> implements Serializable {
    ...
    public static <T> CommonResult<T> error(String message) {
        return error(ErrorCode.UNKNOWN.getCode(), message);
    }

    public static <T> CommonResult<T> error(Integer code, String message) {
        Assert.isTrue(ErrorCode.SUCCESS.getCode() != code, "code 必须是错误的！");
        CommonResult<T> result = new CommonResult<>();
        result.code = code;
        result.msg = message;
        result.rid = Optional.ofNullable(TraceIdUtils.getTraceId()).orElse("");
        return result;
    }
    ...
    public static <T> CommonResult<T> success(T data) {
        ...
        result.data = data;
        result.msg = ErrorCode.SUCCESS.getMsg();
        result.rid = Optional.ofNullable(TraceIdUtils.getTraceId()).orElse("");
        return result;
    }
